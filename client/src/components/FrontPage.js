      ...
      <div className="advantage-container row">
        <div className="col l12 m12 row">
          <div className="advantage col l6 m6">
            ...
            <h3>цаг хэмнэлт</h3>
            <h5>
              Бүх хичээлүүд бичлэгээр хадгалагдсан учир хүссэн сэдвээ алгасах,
          ...
          <div className="advantage col l6 m6">
            ...
            <h3>Хямд үнэ</h3>
            <h5>
              Бусад тэнхимийн сургалтууд, тэр бүү хил бусад онлайн сургалтуудтай
              харьцуулшгүй хямд үнэтэй.
            </h5>
          </div>
        </div>
        <div className="col l12 m12 row">
          ...
          <div className="advantage col l6 m6">
            ...
            <h5>
              Манай багш нар зааж буй хичээлийнхээ жинхэнэ шалгалтад дээр төгс
              оноотой буюу 100%-ийн гүйцэтгэлтэй бөгөөд зарим нь тухайн
              хичээлээрээ 1-4 удаагийн ОУ-ын медальтай мэргэшсэн багш нар билээ.
            </h5>
          </div>
        </div>
        <div className="row col l12 m12">
          <div className="advantage col l6 m6">
            ...
            <h5>
              ...
              сургуульдаа тэнцэн орсон Япон, Солонгос, Хятад, Унгар, Австрали
              зэрэг улсуудад сурч буй оюутнуудтай тэдний хэрхэн элсэн орсон
          ...
          <div className="advantage col l6 m6">
            ...
            <h5>
              Сурагчид даа тухайн хичээлийнхээ багштайгаа долоо хоног бүр
              ганцаарчилсан хувийн зөвлөгөө авах боломжийг олгоно. Энэ цагаар
        ...
        <div className="col l12 m12 row">
          <div className="advantage col l6 m6">
            ...
            <h5>
              ...
              сурагчид даа анхаарч төвлөрсөн тул маш олон төрлийн багц бэлдсэн
              байгаа.
            </h5>
          </div>
          <div className="advantage col l6 m6">
